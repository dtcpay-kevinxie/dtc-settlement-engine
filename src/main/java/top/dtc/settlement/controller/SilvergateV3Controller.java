...
@Log4j2
@RequestMapping("/silvergate/v3")
@RestController
public class SilvergateV3Controller {

    @Autowired
    SilvergateV3Service apiService;
...
//    public ApiResponse<AccountBalanceResp> getAccountBalance(@PathVariable("accountNumber") String accountNumber) {
...
//    }
    ...
    public ApiResponse<AccountListResp> getAccountList() {
        log.debug("[GET] /account/get-account-list");
